...
int main(int argc, char *argv[])
{
  ...
  // Parse configuration file and initialise device + numerics. The
  // BlockTimer is scoped to this block so it credits the INIT phase
  // before palace::Run starts its own timing.
